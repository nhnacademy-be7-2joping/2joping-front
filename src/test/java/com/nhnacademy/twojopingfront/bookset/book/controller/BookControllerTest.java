...
class BookControllerTest {
    ...
    void getAllBooks() throws Exception {
        Page<BookSimpleResponseDto> bookPage = new PageImpl<>(List.of(new BookSimpleResponseDto(1L, "Title", "Thumbnail", 10000, "Publisher", 12000)));
    ...
    void getBookByBookId() throws Exception {
        BookResponseDto bookResponse = new BookResponseDto(1L, "Title", "Description", "2023-10-01", LocalDate.now(), "1234567890123", 10000, 9000, true, true, 10, 0,0,"thumbnail");
