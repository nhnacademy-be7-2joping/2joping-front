...
public class ReviewController {
    ...
    public String showRegisterReviewForm(Model model) {
        model.addAttribute("review", new ReviewCreateRequestDto( null, null, null, 0, "", "", ""));
     ...
     */
    @PostMapping()
    public String registerReview(@ModelAttribute ReviewCreateRequestDto reviewCreateRequestDto) {
    ...
    public String showEditReviewForm(@PathVariable Long reviewId, Model model) {
        ...
        return "review/modify-review"; // 리뷰 수정 폼 페이지
    }

    /**
     * 리뷰 수정 요청을 처리
     * @param reviewId 수정할 리뷰 ID
     * @param reviewModifyRequestDto 수정할 리뷰 정보
    ...
    public String modifyReview(@PathVariable Long reviewId, ReviewModifyRequestDto reviewModifyRequestDto) {
        ...
        return "redirect:/reviews/" + reviewId; // 수정된 리뷰 상세 페이지로 리다이렉트
    }
