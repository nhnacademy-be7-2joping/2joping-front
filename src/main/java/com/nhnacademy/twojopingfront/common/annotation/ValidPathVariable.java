 ...
 *
 * <p>예를 들어, 음수 값이 허용되지 않는 경로 변수를 정의하고 싶을 때, 해당 변수에 이 어노테이션을 추가하고
 * AOP를 통해 유효성을 검사할 수 있습니다.</p>
 *
 * <pre>
 * &#64;ValidPathVariable
 ...
 * </pre>
 *
 * <p>이 어노테이션은 메서드 파라미터에만 사용할 수 있습니다.</p>
 *
 * @see com.nhnacademy.twojopingfront.common.aop.pathvariable.PathvariableAspect
 * @author Luha
 * @since 1.0
 */
