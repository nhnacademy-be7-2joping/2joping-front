...
class WrapControllerTest {
    ...
    /**
     * 포장 상품을 생성한 후 리디렉션이 정상적으로 이루어지는지 확인합니다.
     */
    @Test
    void testCreateWrap() throws Exception {
        WrapRequestDto requestDto = new WrapRequestDto("포장 상품1", 1000, true);
    ...
    /**
     * 특정 포장 상품을 조회하는 기능을 테스트합니다.
     */
    @Test
    void testGetWrap() throws Exception {
        WrapResponseDto responseDto = new WrapResponseDto(1L, "포장 상품1", 1000, true);
    ...
    /**
     * 포장 상품을 업데이트한 후 리디렉션이 정상적으로 이루어지는지 확인합니다.
     */
    @Test
